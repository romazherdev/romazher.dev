...
You don't need to worry about where your CSS lives, how to optimally reuse it, what class names to use and so on. The framework will take care of that. You just need to write code. 
